...
let image2 = await resolveImage("https://media.discordapp.net/attachments/828548538732118036/938798323802964038/580.png?width=187&height=406");
...
.setTextSize(80)
//.printText("قائمة الالوان", 400, 80); //كللام على الصورة
